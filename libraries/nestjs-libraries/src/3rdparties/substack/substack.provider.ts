...
@ThirdParty({
  ...
  title: 'Substack',
  description:
    'Forward post content to a Substack-connected webhook. Enter a webhook URL to receive post data for Substack publishing automation.',
  position: 'webhook',
  fields: [],
})
export class SubstackProvider extends ThirdPartyAbstract {
